A python script to add timezone definitions to a ICS file for it to be compatible e.g. with Mac Calendar or outlook.com calendar. Additionally you can also add reminders to the ICS file.
